(function (forte) {
    ...
    function signalrService($rootScope, $log) {
        ...
        //    //notifications.client.channelStatusChanged = function (sessionId, classId, channelStatus, data) {
        //    //    $log.debug('signalR:channelStatusChanged', [sessionId, classId, channelStatus, data]);
        //    //    $rootScope.$broadcast('channel-status-changed', {
        //    //        sessionId: sessionId,
        //    //        classId: classId,
