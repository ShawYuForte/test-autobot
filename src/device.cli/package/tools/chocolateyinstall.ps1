...
$packageName= 'device-cli' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'device-cli*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = ''
